...
const mapStateToProps = (GlobalState) => {
  ...
  return {
    ...
    homeMenu: [
      {
        title: translations[LanguageReducer.language]?.animations,
      ...
      {
        title: translations[LanguageReducer.language]?.maps,
      ...
      {
        title: translations[LanguageReducer.language]?.camera,
      ...
      {
        title: translations[LanguageReducer.language]?.file,
      ...
      {
        title: translations[LanguageReducer.language]?.PDF,
        id: keyNavigation.DISCOVERY_CHAT,
        sortIndex: 5,
        iconColor: "blue",
        iconName: "logo-firebase",
      ...
      {
        title: translations[LanguageReducer.language]?.video,
        id: keyNavigation.DISCOVERY_CHAT,
        sortIndex: 6,
        iconColor: "blue",
        iconName: "logo-firebase",
      ...
      {
        title: translations[LanguageReducer.language]?.chart,
        id: keyNavigation.DISCOVERY_CHAT,
        sortIndex: 7,
        iconColor: "blue",
        iconName: "logo-firebase",

...
const PAN_GESTURE_HANDLER_FAIL_X = [-SizeRpScreen.device_width, SizeRpScreen.device_width];
const PAN_GESTURE_HANDLER_ACTIVE_Y = [-2, 2];
const CAPTURE_BUTTON_SIZE = 2;
...
const _CaptureButton: React.FC<Props> = ({
    ...
    //         const startY = context.startY ?? SizeRpScreen.device_height;
